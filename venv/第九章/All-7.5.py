...
def make_autopct(values):
    ...
    return my_autopct
plt.pie(y_All, labels=x_All, autopct=make_autopct(y_All),pctdistance=0.6,labeldistance=1.1,radius=1.4)
plt.legend(x_All,loc="upper left",bbox_to_anchor=(1.04, 1, 0.1, 0.1))
# 全量条形图
ax2 = fig.add_subplot(4,2, 2)
ax2 = sns.barplot(x=x_All, y=y_All, data=df_All, palette="pastel")  # seaborn画柱状图 data可以删除
plt.xticks(fontsize=10)  # 设置x和y轴刻度值字体大小
plt.yticks(fontsize=10)
# plt.yticks(np.arange(0, 300, 50))   #设置y轴标签
plt.xlabel("全量地市", fontsize=10)  # 设置x轴和y轴标签字体大小
plt.ylabel("全量话题数", fontsize=10)
...
plt.pie(y_Apr, labels=x_Apr, autopct=make_autopct(y_Apr),pctdistance=0.6,labeldistance=1.1,radius=1.4)
plt.legend(x_All,loc="upper left",bbox_to_anchor=(1.6, 0.2, 0.4, 0.8))
# 4月条形图
...
plt.yticks(fontsize=10)
# plt.yticks(np.arange(0, 300, 50))   #设置y轴标签
plt.xlabel("4月地市", fontsize=10)  # 设置x轴和y轴标签字体大小
plt.ylabel("4月话题数", fontsize=10)
...
plt.pie(y_May, labels=x_May, autopct=make_autopct(y_May),pctdistance=0.6,labeldistance=1.1,radius=1.4)
plt.legend(x_All,loc="upper left",bbox_to_anchor=(1.6, 0.2, 0.4, 0.8))
# 5月条形图
...
plt.yticks(fontsize=10)
# plt.yticks(np.arange(0, 300, 50))   #设置y轴标签
plt.xlabel("5月地市", fontsize=10)  # 设置x轴和y轴标签字体大小
plt.ylabel("5月话题数", fontsize=10)
...
plt.pie(y_Jun, labels=x_Jun, autopct=make_autopct(y_Jun),pctdistance=0.6,labeldistance=1.1,radius=1.4)
plt.legend(x_All,loc="upper left",bbox_to_anchor=(1.6, 0.2, 0.4, 0.8))
# 6月条形图
...
plt.yticks(fontsize=10)
# plt.yticks(np.arange(0, 300, 50))   #设置y轴标签
plt.xlabel("6月地市", fontsize=10)  # 设置x轴和y轴标签字体大小
plt.ylabel("6月话题数", fontsize=10)
