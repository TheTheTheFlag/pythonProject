...
df3.to_excel('d:/WJ/机器学习输入/SRE驳回.xlsx')
...
df7.to_excel('d:/WJ/机器学习输入/SRE通过.xlsx')
...
bar4 = (
    Bar(init_opts=opts.InitOpts(width="900px", height="1000px", theme=ThemeType.WHITE))
        ...
        .reversal_axis()
        .set_series_opts(label_opts=opts.LabelOpts(position="right"))
        .set_global_opts(title_opts=opts.TitleOpts(title='上月SRE质检驳回数量TOP10'),
                         #  datazoom_opts=opts.DataZoomOpts(),
                         xaxis_opts=opts.AxisOpts(name_rotate=60, axislabel_opts={"rotate": 25}),
...
bar6 = (
    Bar(init_opts=opts.InitOpts(width="900px", height="1000px", theme=ThemeType.WHITE))
        ...
        .reversal_axis()
        .set_series_opts(label_opts=opts.LabelOpts(position="right"))
        .set_global_opts(title_opts=opts.TitleOpts(title='上月SRE质检通过数量TOP10'),
                         #  datazoom_opts=opts.DataZoomOpts(),
                         xaxis_opts=opts.AxisOpts(name_rotate=60, axislabel_opts={"rotate": 25}),
