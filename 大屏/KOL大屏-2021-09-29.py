...
# 获取数据列表
df_001 = pd.read_excel('近7天活跃人数.xls')
...
# 获取数据列表
df_003_ = pd.read_excel('近6月地市活跃人数.xls')
...
#  003漏斗图-话题攻克情况
df_004_ = pd.read_excel('地市话题攻克情况.xls')
...
time_list_005_ = get_nday_list_005_(8)
# 获取数据列表
df_005_ = pd.read_excel('近6月地市话题类型.xls')
...
# 获取数据列表
df_006_ = pd.read_excel('地市话题攻克情况.xls')
...
# 006表格-上周活跃详情
df_007_ = pd.read_excel('上周活跃详情.xls')
...
# 获取数据列表
df_008_ = pd.read_excel('近6月地市活跃人数.xls')
...
def page_draggable_layout():
    ...
    page.render("大咖说.html")


if __name__ == "__main__":
    page_draggable_layout()

with open(os.path.join(os.path.abspath("."), "大咖说.html"), 'r+', encoding="utf8") as html:
...
# Page.save_resize_html('大咖说.html', cfg_file='chart_config.json', dest='大屏展示.html')